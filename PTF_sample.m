...
%%Output: ParScenBS, ProbScenBSFact, ProbScenBS, ParScenPS, ProbScenBSFact, ProbScenPS
%%%%%%%%%%%%%%%%%
[ScenarioProb] =Scenario_selection(ScenarioProb)
...
if ScenarioProb.BScomputedYN
   % spatial selection
   DistAll = distance( ScenarioProb.ParScenBS(:,4),ScenarioProb.ParScenBS(:,3),EarlyEst.lat,EarlyEst.lon )*111;
...
if ScenarioProb.PScomputedYN
   % spatial selection
   DistAll = distance( ScenarioProb.ParScenPS(:,4),ScenarioProb.ParScenPS(:,3),EarlyEst.lat,EarlyEst.lon )*111; 
